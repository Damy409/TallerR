Algoritmo EDAD
	...
	//Si la edad es de 0 a 10 años "niño", si la edad es de 11 a 14 años "púber", si la edad es de 15 a 18 años "adolescente",
	//si la edad es de 19 a 25 años "joven", si la edad es de 26 años en adelante "adulto".
	//Analisis: Dependiendo de la edad registrada por el usuario, y con la ayuda de el condicional si Entonces
	//sabremos si la persona es un Niño, Puber, Adulto, Joven o Adolecente.
	//Salidas: Si es Niño, Puber, Adulto, Joven o Adolecente.
